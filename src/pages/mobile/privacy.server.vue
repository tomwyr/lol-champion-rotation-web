<template>
  <PageLayout>
    <template #header>
      <AppPageHeader title="Mobile application privacy policy" />
    </template>

    <template #body>
      <p class="pt-4 pb-8">
        <span class="font-bold">Effective Date: 28.09.2025</span>
        <br />
        <br />
        <span>
          This privacy policy applies to the LoL Champion Rotation app (hereby referred to as
          "Application") for mobile devices that was created by Tomasz Wyrowiński (hereby referred
          to as "Service Provider") as a Free service. This service is intended for use "AS IS".
        </span>
        <br />
        <br />
        <span class="font-bold">Information Collection and Use</span>
        <br />
        <br />
        <span>
        ...
        <span>
          ...
          to provide us with certain personally identifiable information. The information that the
          Service Provider request will be retained by them and used as described in this privacy
          policy.
        </span>
        <br />
        <br />
        <span class="font-bold">Firebase Services</span>
        <br />
        <br />
        <span> The Application uses Firebase Crashlytics and Firebase Analytics: </span>
        <br />
        <span>
          • Crashlytics collects information about app crashes, including device identifiers and
          technical data, to help improve stability.
          <br />
          • Analytics collects usage information such as session duration, screen views, and user
          interactions to improve the Application.
        </span>
        <br />
        <br />
        <span> Firebase may collect data in accordance with its Privacy Policy. </span>
        <br />
        <br />
        <span class="font-bold">Third Party Access</span>
        <br />
        <br />
        <span>
        ...
        <span>
          •
          <a class="font-bold" target="_blank" href="https://google.com/policies/privacy/"
        ...
        <br />
        <br />
        <span class="font-bold">Opt-Out Rights</span>
        <br />
        <br />
        <span>
        ...
        <br />
        <br />
        <span class="font-bold">Data Retention Policy</span>
        <br />
        <br />
        <span>
          ...
          <a class="font-bold" :href="`mailto:${supportEmail}`">{{ supportEmail }}</a>
        ...
        <span>
          ...
          information, please contact the Service Provider (<a
            class="font-bold"
        ...
        <br />
        <br />
        <span class="font-bold">Changes</span>
        <br />
        <br />
        <span>
        ...
        <br />
        <br />
        <span class="font-bold">Your Consent</span>
        <br />
        <br />
        <span>
        ...
        <span class="text-sm font-thin">
          ...
          <a class="font-bold" href="https://app-privacy-policy-generator.nisrulz.com/">
...
const supportEmail = 'support@championrotation.lol'
</script>
